<?php
/**
 * Load the attendee whitelist into `volunteer_allowed`.
 *
...
$pdo = db();
$ins = $pdo->prepare('INSERT IGNORE INTO volunteer_allowed (email) VALUES (?)');
...
$total = (int) $pdo->query('SELECT COUNT(*) FROM volunteer_allowed')->fetchColumn();
