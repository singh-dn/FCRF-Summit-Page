...
<title>Volunteer Certificate — FutureCrime Summit 2026</title>
    ...
    <div class="w-full max-w-[460px]">
      ...
      <header class="flex items-start justify-between mb-6 px-1">
        <div class="min-w-0 pr-3">
          ...
          <p class="text-[17px] font-bold text-white mt-3">Volunteer Certificate</p>
          <p class="text-[15px] text-[#b9c6f2] mt-2">Download your certificate of appreciation</p>
        </div>
      ...
      <section class="bg-[#f7f8fa] text-[#111318] rounded-[28px] card-shadow p-7 sm:p-8">
        ...
        <div id="step1" class="fade">
          ...
          <p class="text-[15px] text-[#6b7280] mt-2 leading-relaxed">
            Enter the email you registered as a volunteer with, and the name you want printed on your certificate.
          </p>
      ...
      <p class="text-center text-[12px] text-[#c9d3f5]/80 mt-6">
        Only registered FutureCrime Summit 2026 volunteers can download a certificate.
      </p>
    </div>
  </main>
...
const REASONS = {
  ...
  not_registered:['email',"This email isn't on the volunteer list. Use the email you registered with."],
