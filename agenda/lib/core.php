...
function fcs_json_out($data, int $code = 200): never
{
    ...
    // dump, a stray blank line after a closing PHP tag in an edited file,
    // a UTF-8 BOM added by a file manager — lands in front of the JSON and
    // makes the browser fail with "Unexpected token". Capture it, log it, drop it.
    $stray = '';
